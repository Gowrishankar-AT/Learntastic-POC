...
@CucumberOptions(features = "src/test/resources/features/SingleUser", glue = {
		"com.thinktimetechno.projects.website.stepdefinitions.SingleUser", "com.thinktimetechno.hooks" }, plugin = {
				...
				"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" }, monochrome = true, tags = "@SU_TC_06_Login_via_Email")

public class SU_TC_06_Login_via_Email_TestRunner extends AbstractTestNGCucumberTests {
	@Override
