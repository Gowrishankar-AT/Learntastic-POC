...
@CucumberOptions(features = "src/test/resources/features/SingleUser", glue = {
		"com.thinktimetechno.projects.website.stepdefinitions.SingleUser", "com.thinktimetechno.hooks" }, plugin = {
				...
				"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" }, monochrome = true, tags = "@SU_TC_24_Virtual_Session_Store_Item_Purchase")

public class SU_TC_24_Virtual_Session_from_Store_Item_Purchase extends AbstractTestNGCucumberTests {
	@Override
