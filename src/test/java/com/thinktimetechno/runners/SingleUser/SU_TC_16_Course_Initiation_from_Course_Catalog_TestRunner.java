...
@CucumberOptions(features = "src/test/resources/features/SingleUser", glue = {
		"com.thinktimetechno.projects.website.stepdefinitions.SingleUser", "com.thinktimetechno.hooks" }, plugin = {
				...
				"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" }, monochrome = true, tags = "@SU_TC_16_Course_Initiation_from_store_purchase")

public class SU_TC_16_Course_Initiation_from_Course_Catalog_TestRunner extends AbstractTestNGCucumberTests {
	@Override
